...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    /// </summary>
    public class DynamicLeapMoveProvider : LeapMoveProvider
    {
        /// <summary>
        ...
        /// <inheritdoc />
        protected override Vector3 ComputeDesiredMove(float inputB)
        {
            ...
            var totalSqrMagnitude = leftHandValue + rightHandValue;
            var leftHandBlend = 0.5f;
            if (totalSqrMagnitude > Mathf.Epsilon)
                leftHandBlend = leftHandValue / totalSqrMagnitude;
            ...
            return base.ComputeDesiredMove(inputB);
        }
    }
}
